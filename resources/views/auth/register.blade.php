...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('tamplate/assets/images/logo/favicon.png') }}" type="image/png"></head>
...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            <div class="auth-logo">
                <a href="index.html"><img src="{{ asset('template1/assets/images/logo/logo.svg') }}" alt="Logo"></a>
            </div>
